...
CREATE TABLE `notice`  (
  ...
  `template_id` bigint NOT NULL DEFAULT 0 COMMENT '消息模板id',
  `target_id` bigint NOT NULL DEFAULT 0 COMMENT '消息内容id',
  `user_id` bigint NOT NULL DEFAULT 0 COMMENT '接收者id',
  `type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '通知类型like,reply,recommand,notification',
  `is_read` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '1已读，0未读',
  `create_by` bigint NOT NULL DEFAULT 0 COMMENT '创建者id',
  `update_by` bigint NOT NULL DEFAULT 0 COMMENT '更新者id',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '0未删、1已删',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '已发通知表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notice_target`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '通知的具体内容',
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '内容链接',
  `is_fanout` tinyint NOT NULL DEFAULT 0 COMMENT '1代表该消息发送给所有人，0代表发送给特定人群',
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '0未删，1已删',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notice_template`  (
  ...
  `type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '通知类型like,reply,recommand,notification',
  `create_by` bigint NOT NULL COMMENT '创建者id',
  `update_by` bigint NOT NULL COMMENT '更新者id',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '0未删，1已删',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知模板表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of notice_template
-- ----------------------------
INSERT INTO `notice_template` VALUES (1, '产品消息', 'SSL证书提交审核通知', 'notification', 1, 1, NULL, NULL, 0);
INSERT INTO `notice_template` VALUES (2, '产品消息', '域名实名认证成功', 'notification', 1, 1, NULL, NULL, 0);
INSERT INTO `notice_template` VALUES (3, '喜欢', '喜欢了', 'like', 0, 0, '2021-02-23 20:14:21', '2021-02-23 20:15:40', 0);
INSERT INTO `notice_template` VALUES (4, '评论', '回复了', 'reply', 0, 0, '2021-02-23 20:14:49', '2021-02-23 20:14:49', 0);
INSERT INTO `notice_template` VALUES (5, '系统消息', '服务器即将更新', 'notification', 1, 1, '2021-02-24 16:29:58', '2021-02-24 16:29:58', 1);
INSERT INTO `notice_template` VALUES (6, '信息变更', '您的角色已变更', 'notification', 1, 1, '2021-02-24 16:53:16', '2021-02-24 16:53:16', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '部门' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '岗位' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 131 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统菜单' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_menu` VALUES (123, 0, 2, 0, '通知管理', '', '', 20, 'gonggao', 'notice', b'0', b'0', b'0', NULL, 1, 1, '2021-02-24 09:46:57', '2021-02-24 09:46:57', b'0');
INSERT INTO `sys_menu` VALUES (124, 123, 3, 1, '模板管理', 'Template', 'notice/template/index', 999, 'message', 'template', b'0', b'0', b'0', 'noticeTemplate:list', 1, 1, '2021-02-24 09:48:48', '2021-02-24 09:48:48', b'0');
INSERT INTO `sys_menu` VALUES (125, 124, 0, 2, '新增模板', '', '', 999, '', '', b'0', b'0', b'0', 'noticeTemplate:add', 1, 1, '2021-02-24 09:48:48', '2021-02-24 09:48:48', b'0');
INSERT INTO `sys_menu` VALUES (126, 124, 0, 2, '修改模板', '', '', 999, '', '', b'0', b'0', b'0', 'noticeTemplate:edit', 1, 1, '2021-02-24 09:48:48', '2021-02-24 09:48:48', b'0');
INSERT INTO `sys_menu` VALUES (127, 124, 0, 2, '删除模板', '', '', 999, '', '', b'0', b'0', b'0', 'noticeTemplate:del', 1, 1, '2021-02-24 09:48:48', '2021-02-24 09:48:48', b'0');
INSERT INTO `sys_menu` VALUES (128, 123, 3, 1, '内容管理', 'Target', 'notice/target/index', 999, 'swagger', 'noticeTarget', b'0', b'0', b'0', 'noticeTarget:list', 1, 1, '2021-02-24 15:48:21', '2021-02-24 15:48:21', b'0');
INSERT INTO `sys_menu` VALUES (129, 128, 0, 2, '新增', '', '', 999, '', '', b'0', b'0', b'0', 'noticeTarget:add', 1, 1, '2021-02-24 16:39:27', '2021-02-24 16:39:27', b'0');
INSERT INTO `sys_menu` VALUES (130, 128, 0, 2, '修改', '', '', 999, '', '', b'0', b'0', b'0', 'noticeTarget:edit', 1, 1, '2021-02-24 16:39:52', '2021-02-24 16:39:52', b'0');
INSERT INTO `sys_menu` VALUES (131, 128, 0, 2, '删除', '', '', 999, '', '', b'0', b'0', b'0', 'noticeTarget:del', 1, 1, '2021-02-24 16:40:13', '2021-02-24 16:40:13', b'0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 110 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色菜单关联' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_roles_menus` VALUES (90, 32, 1);
INSERT INTO `sys_roles_menus` VALUES (91, 128, 1);
INSERT INTO `sys_roles_menus` VALUES (92, 1, 1);
INSERT INTO `sys_roles_menus` VALUES (93, 129, 1);
INSERT INTO `sys_roles_menus` VALUES (94, 2, 1);
INSERT INTO `sys_roles_menus` VALUES (95, 130, 1);
INSERT INTO `sys_roles_menus` VALUES (96, 3, 1);
INSERT INTO `sys_roles_menus` VALUES (97, 35, 1);
INSERT INTO `sys_roles_menus` VALUES (98, 131, 1);
INSERT INTO `sys_roles_menus` VALUES (99, 5, 1);
INSERT INTO `sys_roles_menus` VALUES (100, 37, 1);
INSERT INTO `sys_roles_menus` VALUES (101, 6, 1);
INSERT INTO `sys_roles_menus` VALUES (102, 7, 1);
INSERT INTO `sys_roles_menus` VALUES (103, 39, 1);
INSERT INTO `sys_roles_menus` VALUES (104, 41, 1);
INSERT INTO `sys_roles_menus` VALUES (105, 123, 1);
INSERT INTO `sys_roles_menus` VALUES (106, 28, 1);
INSERT INTO `sys_roles_menus` VALUES (107, 124, 1);
INSERT INTO `sys_roles_menus` VALUES (108, 125, 1);
INSERT INTO `sys_roles_menus` VALUES (109, 126, 1);
INSERT INTO `sys_roles_menus` VALUES (110, 127, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户角色关联' ROW_FORMAT = COMPACT;
