...
--
-- Host: 59.110.218.15    Database: eladmin
-- ------------------------------------------------------
...
CREATE TABLE `sys_dept` (
  ...
  `pid` bigint DEFAULT '0' COMMENT '上级部门',
...
CREATE TABLE `sys_menu` (
  ...
  `pid` bigint DEFAULT '0' COMMENT '上级菜单ID',
...
INSERT INTO `sys_quartz_job` VALUES (2,'testTask','0/5 * * * * ?',_binary '','测试1','run1','test','带参测试，多参使用json','测试',NULL,NULL,NULL,NULL,'admin','2019-08-22 14:08:29','2020-05-05 17:26:19'),(3,'testTask','0/5 * * * * ?',_binary '','测试','run','','不带参测试','Zheng Jie','','2,6',_binary '',NULL,'admin','2019-09-26 16:44:39','2020-05-05 20:45:39'),(5,'Test','0/5 * * * * ?',_binary '','任务告警测试','run',NULL,'测试','test','',NULL,_binary '','admin','admin','2020-05-05 20:32:41','2020-05-05 20:36:13'),(6,'testTask','0/5 * * * * ?',_binary '','测试3','run2',NULL,'测试3','Zheng Jie','',NULL,_binary '','admin','admin','2020-05-05 20:35:41','2020-05-05 20:36:07');
...
--
-- Table structure for table `tool_picture`
--
...
--
-- Dumping data for table `tool_picture`
--

LOCK TABLES `tool_picture` WRITE;
/*!40000 ALTER TABLE `tool_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `tool_picture` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-11-30 14:05:34
